...
import * as schema from '@player/models/schema/weekly/nextGen/weekly.nextgen.pass.schema';
import { DataTypes, Model, Sequelize } from 'sequelize';
import { 
    NFLSchema, 
    WeeklyNextGenPassModelLabel as ModelLabel, 
    WeeklyNextGenPassTable as Table 
} from '@constants/nfl/service.constants';

describe('Weekly NextGen Pass Schema', () => {
    ...
    describe('Model Schema', () => {
        it('should return schema model options', () => {
            expect(schema.weeklyNextGenPassModelOptions(sequelize)).toEqual({
        ...
        it('should return model schema', () => {
            ...
            expect(schema.weeklyNextGenPassSchema(model)).toEqual(modelSchema);
